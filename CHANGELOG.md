...
### Added
- Soporte para mostrar el Stack en el itemTooltip cuando se ver en la AH
- Incluido soporte para Auctionator
...
### Added
- Soporte inicial para IconID.
- Checkboxes individuales en opciones del addon.
